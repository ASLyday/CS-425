...
//
const uint16_t DefaultPort = 8126; // Update this variable with your assigned port value
...
int main(int argc, char* argv[]) {
    ...
    while (connection) {
        ...
        //   information.
        auto testThread = std::async([&,msg](){
        HTTPRequest request(msg);
        
        //std::future<HTTPRequest> myRequest = std::async(std::launch::async, request, msg);
